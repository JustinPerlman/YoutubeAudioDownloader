...
YT_DLP_BASE_COMMAND = [
    'yt-dlp',
    '-x',
    '--audio-format', 'm4a', # <-- CHANGED from 'mp3' to 'm4a'
    '--audio-quality', '0',
...
def main():
    ...
    try:
        ...
        print(f"Error: The input file '{JSON_FILE}' was not found. Please ensure it's in the same directory.")
        return
    ...
    try:
        ...
        print("Error: JSON structure is unexpected. Expected a list of playlists with a 'tracks' key.")
        return
